...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">C.A.C DASHBOARD</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-signal"></i> Tablas &amp; Graficas</a>
  <ul>
    <li><a href="index.html"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    <li class="active"> <a href="charts.html"><i class="icon icon-signal"></i> <span>Tablas &amp; Graficas</span></a> </li>
    <li><a href="tables.html"><i class="icon icon-th"></i> <span>Tablas</span></a></li>
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Mantenimiento</span> <span class="label label-important">3</span></a>
      <ul>
        <li><a href="form-common.html">Formas basicas</a></li>
        <li><a href="form-validation.html">Formas con validacion</a></li>
        <li><a href="form-wizard.html">Formas con el asistente</a></li>
      </ul>
    </li>
    <li class="submenu"> <a href="#"><i class="icon icon-file"></i> <span>Complementos</span> <span class="label label-important">5</span></a>
      <ul>
        <li><a href="index2.html">Dashboard2</a></li>
        <li><a href="gallery.html">Galeria</a></li>
        <li><a href="calendar.html">Calendario</a></li>
        <li><a href="invoice.html">Factura</a></li>
        <li><a href="chat.html">Opcion de chat</a></li>
      </ul>
    </li>
    </li>
  </ul>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#" class="current">Tablas &amp; graficas</a></div>
    <h1>Tablas &amp; graficas</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5> Produccion en Tiempo real</h5>
          </div>
...
<div id="barchart_values" style="width: 900px; height: 300px;"></div>
    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-signal"></i> </span>
            <h5>Grafica sobre estandar de la Razas</h5>
          </div>
          <div class="widget-content">
...
<script src="js/jquery.peity.min.js"></script> 
 ...
 <script type="text/javascript">
    ...
    function drawChart() {
      ...
      var chart = new google.visualization.BarChart(document.getElementById("placeholder2"));
