...
>>>>>>> parent of 929df43... modificad
  ...
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      <li class="bg_lb"> <a href="#"> <i class="icon-dashboard"></i> Mi Dashboard </a> </li>
      <li class="bg_lg"> <a href="#"> <i class="icon-shopping-cart"></i> Carrito de compras</a> </li>
      <li class="bg_ly"> <a href="#"> <i class=" icon-globe"></i> Web Marketing </a> </li>
      <li class="bg_lo"> <a href="#"> <i class="icon-group"></i> Administrador de usuarios </a> </li>
      <li class="bg_ls"> <a href="#"> <i class="icon-signal"></i> Comprobacion de las estadisticas</a> </li>
    </ul>
  </div>
